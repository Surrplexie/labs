...
- [x] **Sample executed** (user ran it) — post-run UI captured in **`50_screenshots/IMG_6042`** (see **`02_dynamic`**). **Revert snapshot** when you are done capturing if the VM is disposable.
...
- Screenshots (host): [`50_screenshots/`](../50_screenshots/) -- see `SHOT_INDEX.txt` there.
