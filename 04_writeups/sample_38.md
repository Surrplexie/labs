...
evidence_index:
  acquisition: ../00_original/sample_38.md
  static: ../01_static/sample_38.md
  dynamic: ../02_dynamic/sample_38.md
  findings: ../03_findings/sample_38.md
  screenshots: ../50_screenshots/sample_38/
...
> **Related engagement:** [`sample_38`](../03_findings/sample_38.md) · **Kind:** `<FILL>` · **Classification:** `<FILL>`
...
> For tool-by-tool notes, the phase log is canonical: [`01_static/sample_38.md`](../01_static/sample_38.md). Here, **synthesize** and add interpretation that did not fit the triage template.
...
> Canonical run log: [`02_dynamic/sample_38.md`](../02_dynamic/sample_38.md)
...
> [`03_findings`](../03_findings/sample_38.md) lists IDs; here, **justify** each mapping with technique → observation → confidence.
...
_(See also [`SHOT_INDEX.txt`](../50_screenshots/sample_38/SHOT_INDEX.txt).)_
