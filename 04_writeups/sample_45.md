...
evidence_index:
  acquisition: ../00_original/sample_45.md
  static: ../01_static/sample_45.md
  dynamic: ../02_dynamic/sample_45.md
  findings: ../03_findings/sample_45.md
  screenshots: ../50_screenshots/sample_45/
...
> **Related engagement:** [`sample_45`](../03_findings/sample_45.md) · **Kind:** `<FILL>` · **Classification:** `<FILL>`
...
> For tool-by-tool notes, the phase log is canonical: [`01_static/sample_45.md`](../01_static/sample_45.md). Here, **synthesize** and add interpretation that did not fit the triage template.
...
> Canonical run log: [`02_dynamic/sample_45.md`](../02_dynamic/sample_45.md)
...
> [`03_findings`](../03_findings/sample_45.md) lists IDs; here, **justify** each mapping with technique → observation → confidence.
...
_(See also [`SHOT_INDEX.txt`](../50_screenshots/sample_45/SHOT_INDEX.txt).)_
