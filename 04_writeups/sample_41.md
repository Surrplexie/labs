...
evidence_index:
  acquisition: ../00_original/sample_41.md
  static: ../01_static/sample_41.md
  dynamic: ../02_dynamic/sample_41.md
  findings: ../03_findings/sample_41.md
  screenshots: ../50_screenshots/sample_41/
...
> **Related engagement:** [`sample_41`](../03_findings/sample_41.md) · **Kind:** `<FILL>` · **Classification:** `<FILL>`
...
> For tool-by-tool notes, the phase log is canonical: [`01_static/sample_41.md`](../01_static/sample_41.md). Here, **synthesize** and add interpretation that did not fit the triage template.
...
> Canonical run log: [`02_dynamic/sample_41.md`](../02_dynamic/sample_41.md)
...
> [`03_findings`](../03_findings/sample_41.md) lists IDs; here, **justify** each mapping with technique → observation → confidence.
...
_(See also [`SHOT_INDEX.txt`](../50_screenshots/sample_41/SHOT_INDEX.txt).)_
