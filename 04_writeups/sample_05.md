...
evidence_index:
  acquisition: ../00_original/sample_05.md
  static: ../01_static/sample_05.md
...
> **Related engagement:** [`sample_05`](../03_findings/sample_05.md) · **Kind:** `<FILL>` · **Classification:** `<FILL>`
...
> For tool-by-tool notes, the phase log is canonical: [`01_static/sample_05.md`](../01_static/sample_05.md). Here, **synthesize** and add interpretation that did not fit the triage template.
...
> Canonical run log: [`02_dynamic/sample_05.md`](../02_dynamic/sample_05.md)
...
> [`03_findings`](../03_findings/sample_05.md) lists IDs; here, **justify** each mapping with technique → observation → confidence.
...
_(See also [`SHOT_INDEX.txt`](../50_screenshots/sample_05/SHOT_INDEX.txt).)_
