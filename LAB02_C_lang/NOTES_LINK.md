...
```powershell
powershell -ExecutionPolicy Bypass -File .\30_scripts\link_notes.ps1 -SampleId sample_02 -Course "CS50"
powershell -ExecutionPolicy Bypass -File .\30_scripts\open_session.ps1 -SampleId sample_02
```
